...
inline VkFormatProperties
vkiFormatProperties(VkFormatFeatureFlags linearTilingFeatures,
...
inline VkQueueFamilyProperties
vkiQueueFamilyProperties(VkQueueFlags queueFlags, uint32_t queueCount,
...
vkiDeviceQueueCreateInfo(uint32_t queueFamilyIndex, uint32_t queueCount,
...
inline VkSparseImageFormatProperties
vkiSparseImageFormatProperties(VkImageAspectFlags aspectMask,
...
inline VkSparseBufferMemoryBindInfo
vkiSparseBufferMemoryBindInfo(VkBuffer buffer, uint32_t bindCount,
...
inline VkSparseImageOpaqueMemoryBindInfo
vkiSparseImageOpaqueMemoryBindInfo(VkImage image, uint32_t bindCount,
                                   const VkSparseMemoryBind *pBinds)
{
...
inline VkSparseImageMemoryBind
vkiSparseImageMemoryBind(VkImageSubresource subresource, VkOffset3D offset,
                         VkExtent3D extent, VkDeviceMemory memory,
                         VkDeviceSize memoryOffset)
{
...
inline VkSparseImageMemoryBindInfo
vkiSparseImageMemoryBindInfo(VkImage image, uint32_t bindCount,
...
vkiQueryPoolCreateInfo(VkQueryType queryType, uint32_t queryCount,
...
vkiBufferCreateInfo(VkDeviceSize size, VkBufferUsageFlags usage,
...
vkiImageSubresourceRange(VkImageAspectFlags aspectMask, uint32_t baseMipLevel,
...
vkiImageViewCreateInfo(VkImage image, VkImageViewType viewType, VkFormat format,
...
vkiShaderModuleCreateInfo(size_t codeSize, const uint32_t *pCode)
{
...
inline VkPipelineCacheCreateInfo
vkiPipelineCacheCreateInfo(size_t initialDataSize, const void *pInitialData)
{
...
vkiSpecializationMapEntry(uint32_t constantID, uint32_t offset, size_t size)
{
...
vkiSpecializationInfo(uint32_t mapEntryCount,
...
vkiVertexInputBindingDescription(uint32_t binding, uint32_t stride,
...
vkiVertexInputAttributeDescription(uint32_t location, uint32_t binding,
...
vkiStencilOpState(VkStencilOp failOp, VkStencilOp passOp,
...
vkiPipelineDynamicStateCreateInfo(uint32_t dynamicStateCount,
...
vkiPipelineLayoutCreateInfo(uint32_t setLayoutCount,
...
vkiDescriptorPoolCreateInfo(uint32_t maxSets, uint32_t poolSizeCount,
...
vkiDescriptorSetAllocateInfo(VkDescriptorPool descriptorPool,
...
vkiWriteDescriptorSet(VkDescriptorSet dstSet, uint32_t dstBinding,
...
vkiCopyDescriptorSet(VkDescriptorSet srcSet, uint32_t srcBinding,
...
vkiFramebufferCreateInfo(VkRenderPass renderPass, uint32_t attachmentCount,
                         const VkImageView *pAttachments, uint32_t width,
...
vkiCommandPoolCreateInfo(uint32_t queueFamilyIndex)
{
...
vkiCommandBufferAllocateInfo(VkCommandPool commandPool,
...
vkiImageSubresourceLayers(VkImageAspectFlags aspectMask, uint32_t mipLevel,
...
inline VkBufferImageCopy
vkiBufferImageCopy(VkDeviceSize bufferOffset, uint32_t bufferRowLength,
...
vkiBufferMemoryBarrier(VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask,
                       uint32_t srcQueueFamilyIndex,
                       uint32_t dstQueueFamilyIndex, VkBuffer buffer,
...
vkiImageMemoryBarrier(VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask,
...
vkiRenderPassBeginInfo(VkRenderPass renderPass, VkFramebuffer framebuffer,
...
inline VkDispatchIndirectCommand
vkiDispatchIndirectCommand(uint32_t x, uint32_t y, uint32_t z)
{
...
inline VkDrawIndexedIndirectCommand
vkiDrawIndexedIndirectCommand(uint32_t indexCount, uint32_t instanceCount,
...
inline VkPhysicalDeviceSubgroupProperties
vkiPhysicalDeviceSubgroupProperties(uint32_t subgroupSize,
...
inline VkBindBufferMemoryInfo
vkiBindBufferMemoryInfo(VkBuffer buffer, VkDeviceMemory memory,
                        VkDeviceSize memoryOffset)
{
...
inline VkMemoryDedicatedRequirements
vkiMemoryDedicatedRequirements(VkBool32 prefersDedicatedAllocation,
...
inline VkMemoryDedicatedAllocateInfo
vkiMemoryDedicatedAllocateInfo(VkImage image, VkBuffer buffer)
{
...
inline VkMemoryAllocateFlagsInfo
vkiMemoryAllocateFlagsInfo(uint32_t deviceMask)
{
...
inline VkDeviceGroupRenderPassBeginInfo
vkiDeviceGroupRenderPassBeginInfo(uint32_t deviceMask,
...
inline VkDeviceGroupCommandBufferBeginInfo
vkiDeviceGroupCommandBufferBeginInfo(uint32_t deviceMask)
{
...
inline VkDeviceGroupBindSparseInfo
vkiDeviceGroupBindSparseInfo(uint32_t resourceDeviceIndex,
...
inline VkBindBufferMemoryDeviceGroupInfo
vkiBindBufferMemoryDeviceGroupInfo(uint32_t deviceIndexCount,
...
inline VkBindImageMemoryDeviceGroupInfo
vkiBindImageMemoryDeviceGroupInfo(uint32_t deviceIndexCount,
                                  const uint32_t *pDeviceIndices,
...
inline VkDeviceGroupDeviceCreateInfo
vkiDeviceGroupDeviceCreateInfo(uint32_t physicalDeviceCount,
...
vkiBufferMemoryRequirementsInfo2(VkBuffer buffer)
{
...
inline VkImageMemoryRequirementsInfo2
vkiImageMemoryRequirementsInfo2(VkImage image)
{
...
inline VkMemoryRequirements2
vkiMemoryRequirements2(VkMemoryRequirements memoryRequirements)
{
...
inline VkPhysicalDeviceFeatures2
vkiPhysicalDeviceFeatures2(VkPhysicalDeviceFeatures features)
{
...
inline VkPhysicalDeviceProperties2
vkiPhysicalDeviceProperties2(VkPhysicalDeviceProperties properties)
{
...
inline VkFormatProperties2
vkiFormatProperties2(VkFormatProperties formatProperties)
{
...
inline VkImageFormatProperties2
vkiImageFormatProperties2(VkImageFormatProperties imageFormatProperties)
{
...
inline VkPhysicalDeviceImageFormatInfo2
vkiPhysicalDeviceImageFormatInfo2(VkFormat format, VkImageType type,
...
inline VkQueueFamilyProperties2
vkiQueueFamilyProperties2(VkQueueFamilyProperties queueFamilyProperties)
{
...
inline VkSparseImageFormatProperties2
vkiSparseImageFormatProperties2(VkSparseImageFormatProperties properties)
{
...
inline VkInputAttachmentAspectReference
vkiInputAttachmentAspectReference(uint32_t subpass,
...
inline VkImageViewUsageCreateInfo
vkiImageViewUsageCreateInfo(VkImageUsageFlags usage)
{
...
inline VkPhysicalDeviceMultiviewFeatures
vkiPhysicalDeviceMultiviewFeatures(VkBool32 multiview,
...
inline VkPhysicalDeviceMultiviewProperties
vkiPhysicalDeviceMultiviewProperties(uint32_t maxMultiviewViewCount,
...
inline VkSamplerYcbcrConversionInfo
vkiSamplerYcbcrConversionInfo(VkSamplerYcbcrConversion conversion)
{
...
inline VkBindImagePlaneMemoryInfo
vkiBindImagePlaneMemoryInfo(VkImageAspectFlagBits planeAspect)
{
...
inline VkImagePlaneMemoryRequirementsInfo
vkiImagePlaneMemoryRequirementsInfo(VkImageAspectFlagBits planeAspect)
{
...
inline VkExternalMemoryImageCreateInfo
vkiExternalMemoryImageCreateInfo(VkExternalMemoryHandleTypeFlags handleTypes)
{
...
inline VkExternalMemoryBufferCreateInfo
vkiExternalMemoryBufferCreateInfo(VkExternalMemoryHandleTypeFlags handleTypes)
{
...
inline VkExportMemoryAllocateInfo
vkiExportMemoryAllocateInfo(VkExternalMemoryHandleTypeFlags handleTypes)
{
...
inline VkExportFenceCreateInfo
vkiExportFenceCreateInfo(VkExternalFenceHandleTypeFlags handleTypes)
{
...
inline VkExportSemaphoreCreateInfo
vkiExportSemaphoreCreateInfo(VkExternalSemaphoreHandleTypeFlags handleTypes)
{
...
vkiDescriptorSetLayoutSupport(VkBool32 supported)
{
...
vkiSurfaceCapabilitiesKHR(uint32_t minImageCount, uint32_t maxImageCount,
                          VkExtent2D currentExtent, VkExtent2D minImageExtent,
...
inline VkImageSwapchainCreateInfoKHR
vkiImageSwapchainCreateInfoKHR(VkSwapchainKHR swapchain)
{
...
inline VkBindImageMemorySwapchainInfoKHR
vkiBindImageMemorySwapchainInfoKHR(VkSwapchainKHR swapchain,
                                   uint32_t imageIndex)
{
...
inline VkAcquireNextImageInfoKHR
vkiAcquireNextImageInfoKHR(VkSwapchainKHR swapchain, uint64_t timeout,
...
inline VkDeviceGroupPresentInfoKHR
vkiDeviceGroupPresentInfoKHR(uint32_t swapchainCount,
...
inline VkDeviceGroupSwapchainCreateInfoKHR
vkiDeviceGroupSwapchainCreateInfoKHR(VkDeviceGroupPresentModeFlagsKHR modes)
{
...
inline VkDisplayModeParametersKHR
vkiDisplayModeParametersKHR(VkExtent2D visibleRegion, uint32_t refreshRate)
{
...
inline VkDisplayModePropertiesKHR
vkiDisplayModePropertiesKHR(VkDisplayModeKHR displayMode,
...
inline VkDisplayModeCreateInfoKHR
vkiDisplayModeCreateInfoKHR(VkDisplayModeParametersKHR parameters)
{
...
inline VkDisplayPlanePropertiesKHR
vkiDisplayPlanePropertiesKHR(VkDisplayKHR currentDisplay,
...
inline VkImportMemoryFdInfoKHR
vkiImportMemoryFdInfoKHR(VkExternalMemoryHandleTypeFlagBits handleType,
                         int fd)
{
...
inline VkMemoryFdPropertiesKHR
vkiMemoryFdPropertiesKHR(uint32_t memoryTypeBits)
{
...
inline VkMemoryGetFdInfoKHR
vkiMemoryGetFdInfoKHR(VkDeviceMemory memory,
                      VkExternalMemoryHandleTypeFlagBits handleType)
{
...
inline VkImportSemaphoreFdInfoKHR
vkiImportSemaphoreFdInfoKHR(VkSemaphore semaphore,
                            VkExternalSemaphoreHandleTypeFlagBits handleType,
                            int fd)
{
...
inline VkSemaphoreGetFdInfoKHR
vkiSemaphoreGetFdInfoKHR(VkSemaphore semaphore,
                         VkExternalSemaphoreHandleTypeFlagBits handleType)
{
...
inline VkPresentRegionKHR
vkiPresentRegionKHR(uint32_t rectangleCount,
...
inline VkPresentRegionsKHR
vkiPresentRegionsKHR(uint32_t swapchainCount,
...
inline VkFramebufferAttachmentImageInfoKHR
vkiFramebufferAttachmentImageInfoKHR(VkImageUsageFlags usage, uint32_t width,
...
inline VkRenderPassAttachmentBeginInfoKHR
vkiRenderPassAttachmentBeginInfoKHR(uint32_t attachmentCount,
...
inline VkAttachmentReference2KHR
vkiAttachmentReference2KHR(uint32_t attachment, VkImageLayout layout,
                           VkImageAspectFlags aspectMask)
{
...
inline VkSubpassBeginInfoKHR
vkiSubpassBeginInfoKHR(VkSubpassContents contents)
{
...
inline VkImportFenceFdInfoKHR
vkiImportFenceFdInfoKHR(VkFence fence,
                        VkExternalFenceHandleTypeFlagBits handleType, int fd)
{
...
inline VkFenceGetFdInfoKHR
vkiFenceGetFdInfoKHR(VkFence fence,
                     VkExternalFenceHandleTypeFlagBits handleType)
{
...
inline VkPhysicalDeviceSurfaceInfo2KHR
vkiPhysicalDeviceSurfaceInfo2KHR(VkSurfaceKHR surface)
{
...
inline VkSurfaceCapabilities2KHR
vkiSurfaceCapabilities2KHR(VkSurfaceCapabilitiesKHR surfaceCapabilities)
{
...
inline VkSurfaceFormat2KHR
vkiSurfaceFormat2KHR(VkSurfaceFormatKHR surfaceFormat)
{
...
inline VkDisplayProperties2KHR
vkiDisplayProperties2KHR(VkDisplayPropertiesKHR displayProperties)
{
...
inline VkDisplayModeProperties2KHR
vkiDisplayModeProperties2KHR(VkDisplayModePropertiesKHR displayModeProperties)
{
...
inline VkDisplayPlaneCapabilities2KHR
vkiDisplayPlaneCapabilities2KHR(VkDisplayPlaneCapabilitiesKHR capabilities)
{
...
inline VkImageFormatListCreateInfoKHR
vkiImageFormatListCreateInfoKHR(uint32_t viewFormatCount,
                                const VkFormat *pViewFormats)
{
...
inline VkSemaphoreTypeCreateInfoKHR
vkiSemaphoreTypeCreateInfoKHR(VkSemaphoreTypeKHR semaphoreType,
...
inline VkTimelineSemaphoreSubmitInfoKHR
vkiTimelineSemaphoreSubmitInfoKHR(uint32_t waitSemaphoreValueCount,
...
inline VkSemaphoreWaitInfoKHR
vkiSemaphoreWaitInfoKHR(uint32_t semaphoreCount, const VkSemaphore *pSemaphores,
...
inline VkSurfaceProtectedCapabilitiesKHR
vkiSurfaceProtectedCapabilitiesKHR(VkBool32 supportsProtected)
{
...
inline VkPipelineExecutableInfoKHR
vkiPipelineExecutableInfoKHR(VkPipeline pipeline, uint32_t executableIndex)
{
...
inline VkDebugReportCallbackCreateInfoEXT
vkiDebugReportCallbackCreateInfoEXT(PFN_vkDebugReportCallbackEXT pfnCallback,
                                    void *pUserData)
{
...
inline VkDebugMarkerObjectNameInfoEXT
vkiDebugMarkerObjectNameInfoEXT(VkDebugReportObjectTypeEXT objectType,
                                uint64_t object, const char *pObjectName)
{
...
inline VkDebugMarkerObjectTagInfoEXT
vkiDebugMarkerObjectTagInfoEXT(VkDebugReportObjectTypeEXT objectType,
                               uint64_t object, uint64_t tagName,
...
inline VkImageViewHandleInfoNVX
vkiImageViewHandleInfoNVX(VkImageView imageView,
...
inline VkShaderResourceUsageAMD
vkiShaderResourceUsageAMD(uint32_t numUsedVgprs, uint32_t numUsedSgprs,
...
inline VkExportMemoryAllocateInfoNV
vkiExportMemoryAllocateInfoNV(VkExternalMemoryHandleTypeFlagsNV handleTypes)
{
...
inline VkValidationFlagsEXT
vkiValidationFlagsEXT(uint32_t disabledValidationCheckCount,
...
inline VkImageViewASTCDecodeModeEXT
vkiImageViewASTCDecodeModeEXT(VkFormat decodeMode)
{
...
inline VkConditionalRenderingBeginInfoEXT
vkiConditionalRenderingBeginInfoEXT(VkBuffer buffer, VkDeviceSize offset)
{
...
inline VkSurfaceCapabilities2EXT
vkiSurfaceCapabilities2EXT(uint32_t minImageCount, uint32_t maxImageCount,
                           VkExtent2D currentExtent, VkExtent2D minImageExtent,
                           VkExtent2D maxImageExtent,
                           uint32_t maxImageArrayLayers,
                           VkSurfaceTransformFlagsKHR supportedTransforms,
...
inline VkDisplayPowerInfoEXT
vkiDisplayPowerInfoEXT(VkDisplayPowerStateEXT powerState)
{
...
inline VkDeviceEventInfoEXT
vkiDeviceEventInfoEXT(VkDeviceEventTypeEXT deviceEvent)
{
...
inline VkDisplayEventInfoEXT
vkiDisplayEventInfoEXT(VkDisplayEventTypeEXT displayEvent)
{
...
inline VkSwapchainCounterCreateInfoEXT
vkiSwapchainCounterCreateInfoEXT(VkSurfaceCounterFlagsEXT surfaceCounters)
{
...
inline VkRefreshCycleDurationGOOGLE
vkiRefreshCycleDurationGOOGLE(uint64_t refreshDuration)
{
...
inline VkPresentTimesInfoGOOGLE
vkiPresentTimesInfoGOOGLE(uint32_t swapchainCount,
...
inline VkHdrMetadataEXT
vkiHdrMetadataEXT(VkXYColorEXT displayPrimaryRed,
                  VkXYColorEXT displayPrimaryGreen,
                  VkXYColorEXT displayPrimaryBlue, VkXYColorEXT whitePoint,
                  float maxLuminance, float minLuminance,
                  float maxContentLightLevel, float maxFrameAverageLightLevel)
{
...
inline VkDebugUtilsObjectNameInfoEXT
vkiDebugUtilsObjectNameInfoEXT(VkObjectType objectType, uint64_t objectHandle,
...
inline VkDebugUtilsObjectTagInfoEXT
vkiDebugUtilsObjectTagInfoEXT(VkObjectType objectType, uint64_t objectHandle,
                              uint64_t tagName, size_t tagSize,
                              const void *pTag)
{
...
inline VkSamplerReductionModeCreateInfoEXT
vkiSamplerReductionModeCreateInfoEXT(VkSamplerReductionModeEXT reductionMode)
{
...
inline VkSampleLocationsInfoEXT
vkiSampleLocationsInfoEXT(VkSampleCountFlagBits sampleLocationsPerPixel,
...
inline VkAttachmentSampleLocationsEXT
vkiAttachmentSampleLocationsEXT(uint32_t attachmentIndex,
...
inline VkSubpassSampleLocationsEXT
vkiSubpassSampleLocationsEXT(uint32_t subpassIndex,
                             VkSampleLocationsInfoEXT sampleLocationsInfo)
{
...
inline VkMultisamplePropertiesEXT
vkiMultisamplePropertiesEXT(VkExtent2D maxSampleLocationGridSize)
{
...
inline VkValidationCacheCreateInfoEXT
vkiValidationCacheCreateInfoEXT(size_t initialDataSize,
...
inline VkCoarseSampleLocationNV
vkiCoarseSampleLocationNV(uint32_t pixelX, uint32_t pixelY, uint32_t sample)
{
...
inline VkCoarseSampleOrderCustomNV
vkiCoarseSampleOrderCustomNV(VkShadingRatePaletteEntryNV shadingRate,
                             uint32_t sampleCount, uint32_t sampleLocationCount,
...
inline VkAccelerationStructureInfoNV
vkiAccelerationStructureInfoNV(VkAccelerationStructureTypeNV type,
                               uint32_t instanceCount, uint32_t geometryCount,
...
inline VkAccelerationStructureCreateInfoNV
vkiAccelerationStructureCreateInfoNV(VkDeviceSize compactedSize,
...
inline VkImportMemoryHostPointerInfoEXT
vkiImportMemoryHostPointerInfoEXT(VkExternalMemoryHandleTypeFlagBits handleType,
                                  void *pHostPointer)
{
...
inline VkMemoryHostPointerPropertiesEXT
vkiMemoryHostPointerPropertiesEXT(uint32_t memoryTypeBits)
{
...
inline VkCalibratedTimestampInfoEXT
vkiCalibratedTimestampInfoEXT(VkTimeDomainEXT timeDomain)
{
...
inline VkPipelineCreationFeedbackEXT
vkiPipelineCreationFeedbackEXT(uint64_t duration)
{
...
vkiDrawMeshTasksIndirectCommandNV(uint32_t taskCount, uint32_t firstTask)
{
...
inline VkPerformanceValueINTEL
vkiPerformanceValueINTEL(VkPerformanceValueTypeINTEL type,
...
inline VkInitializePerformanceApiInfoINTEL
vkiInitializePerformanceApiInfoINTEL(void *pUserData)
{
...
inline VkPerformanceMarkerInfoINTEL
vkiPerformanceMarkerInfoINTEL(uint64_t marker)
{
...
inline VkPerformanceStreamMarkerInfoINTEL
vkiPerformanceStreamMarkerInfoINTEL(uint32_t marker)
{
...
inline VkPerformanceOverrideInfoINTEL
vkiPerformanceOverrideInfoINTEL(VkPerformanceOverrideTypeINTEL type,
                                VkBool32 enable, uint64_t parameter)
{
...
inline VkMemoryPriorityAllocateInfoEXT
vkiMemoryPriorityAllocateInfoEXT(float priority)
{
...
inline VkBufferDeviceAddressInfoEXT
vkiBufferDeviceAddressInfoEXT(VkBuffer buffer)
{
...
vkiBufferDeviceAddressCreateInfoEXT(VkDeviceAddress deviceAddress)
{
...
inline VkImageStencilUsageCreateInfoEXT
vkiImageStencilUsageCreateInfoEXT(VkImageUsageFlags stencilUsage)
{
